...
Go [here](https://github.com/milaan9/01_Python_Introduction) if you aren't here already and click the <img src="https://img.shields.io/static/v1?label=%E2%AD%90&message=Star&style=style=flat&colorB=white" alt="Star Badge"/>"⭐ Star" button in the top right corner. You will be asked to create a GitHub account if you don't already have one.
