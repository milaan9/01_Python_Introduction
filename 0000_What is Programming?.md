...
**Feel free to [skip this part](#how-to-read-this-tutorial) if you already know everything it's talking about.**
...
4. If you can't find what you're looking for or you still have trouble
   ...
   please tell me about it by [Create an issue on GitHub](https://github.com/milaan9/01_Python_Introduction/issues/new). 
   I want to improve this tutorial so other readers won't have the same problem as you have.
...
- Now we're ready to [install Python](https://github.com/milaan9/01_Python_Introduction/blob/main/001_How_to_install_Python.ipynb) and
    [get started](https://github.com/milaan9/01_Python_Introduction/blob/main/003_test_file.ipynb) and continue with next file in the list.!
